...
__movies_db_cli_{current_date}(){
    ...
    if [[ $COMP_CWORD == 1 ]]; then
        COMPREPLY=( $(compgen -W "movies server generate -h --help --manual --version" -- "${cur}") )
        return 0
    fi
...
complete -F __movies_db_cli_{current_date} {executable_name}
